...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const initializeSupabase = async () => {
      try {
        ...
        console.log('Supabase initialization error (using mock auth as fallback):', error)
      }
    }
  ...
  return <AuthContext.Provider value={{ user, login, logout, loading, supabaseUser }}>{children}</AuthContext.Provider>
}
